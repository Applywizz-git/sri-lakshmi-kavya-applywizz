...
export const personalInfo: PersonalInfo = {
  ...
  profileImage: "/public/kavya_image1.jpg",
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Messaging app with chat, file sharing, collaboration, WebSockets, and notifications.",
    image: "/placeholder-project1.jpg",
  ...
  // {
  //   id: "proj4",
  //   title: "Real time chat and notification collaborative system",
  //   description: "Real-time chat and notification system enabling instant collaboration and seamless team communication.",
  //   image: "./public/realtime_chat.png",
  //   technologies: ["Node.js", "Express", "Socket.IO", "React", "Tailwind CSS", "MongoDB", "WebSockets", "Redis"],
  //   featured: false
  // },
  {
    id: "proj4",
    title: "AI Generated Portfolio",
    description: "AI-powered portfolio that automatically generates personalized, visually stunning, and professional project showcases",
    image: "./portfolio.png",
   technologies: ["React", "Tailwind CSS", "Framer Motion", "Node.js", "Express", "MongoDB", "OpenAI API"],
